...
export const useDependencyStore = defineStore('dependency', () => {
  ...
  async function create(data: CreateDependencyInput): Promise<Dependency> {
    ...
    try {
      ...
      error.value = t('common.errors.failedToCreate', {
        entity: t('common.entities.dependencies'),
      });
  ...
  async function update(id: string, data: UpdateDependencyInput): Promise<void> {
    ...
    try {
      ...
      error.value = t('common.errors.failedToUpdate', {
        entity: t('common.entities.dependencies'),
      });
    } finally {
      loading.value = false;
  ...
  async function remove(id: string): Promise<void> {
    ...
    try {
      ...
      error.value = t('common.errors.failedToDelete', {
        entity: t('common.entities.dependencies'),
      });
    } finally {
      loading.value = false;
