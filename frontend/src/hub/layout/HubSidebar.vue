...
const monitoringSections: NavSection[] = [
  {
    items: [{ icon: '▦', labelKey: 'nav.dashboard', to: '/monitoring/dashboard' }],
  },
  {
    headingKey: 'nav.sections.catalog',
    items: [
      { icon: '🔌', labelKey: 'nav.providers', to: '/monitoring/catalog/providers' },
      { icon: '📦', labelKey: 'nav.projects', to: '/monitoring/catalog/projects' },
    ],
  },
  {
    headingKey: 'nav.sections.governance',
    items: [
      { icon: '🔧', labelKey: 'nav.frameworks', to: '/monitoring/catalog/frameworks' },
      { icon: '📋', labelKey: 'nav.dependencies', to: '/monitoring/dependency/dependencies' },
      { icon: '🛡', labelKey: 'nav.vulnerabilities', to: '/monitoring/dependency/vulnerabilities' },
      { icon: '🧪', labelKey: 'nav.coverage', to: '/monitoring/coverage' },
    ],
  },
];

const hubSections: NavSection[] = [
  {
    items: [{ icon: '🏠', labelKey: 'nav.home', to: '/' }],
  },
  {
    headingKey: 'nav.sections.account',
    items: [
...
const navSections = computed<NavSection[]>(() => {
  if (route.path.startsWith('/monitoring')) return monitoringSections;
  return hubSections;
});
