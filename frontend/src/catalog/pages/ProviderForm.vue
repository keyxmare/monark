...
const errors = computed(() => ({
  apiToken: touched.apiToken && tokenRequired.value && !form.apiToken
    ? t('common.validation.required')
    : '',
  name: touched.name && !form.name.trim() ? t('common.validation.required') : '',
  url: touched.url && !form.url.trim()
    ? t('common.validation.required')
    : touched.url && !isValidUrl(form.url)
      ? t('common.validation.invalidUrl')
      : '',
  username: touched.username && isGitHub.value && !form.apiToken && !form.username.trim()
    ? t('common.validation.required')
    : '',
}))
            ...
            >
              ...
              <div class="mt-4">
                ...
                <input
                  ...
                  :class="errors.url ? 'border-danger focus:border-danger focus:ring-danger/20' : 'border-border focus:border-primary focus:ring-primary/20'"
                  class="w-full rounded-lg border px-3 py-2 text-text focus:ring-2 focus:outline-none"
              ...
              >
                ...
                <input
                  ...
                  :class="errors.username ? 'border-danger focus:border-danger focus:ring-danger/20' : 'border-border focus:border-primary focus:ring-primary/20'"
                  class="w-full rounded-lg border px-3 py-2 text-text focus:ring-2 focus:outline-none"
              ...
              <div class="mt-4">
                <label
                  for="field-apiToken"
                  class="mb-1 block text-sm font-medium text-text"
                >{{ t('catalog.providers.apiToken') }} <span
                  v-if="tokenRequired"
                  class="text-danger"
                >*</span></label>
                <div class="relative">
                  <input
                    ...
                    :class="errors.apiToken ? 'border-danger focus:border-danger focus:ring-danger/20' : 'border-border focus:border-primary focus:ring-primary/20'"
              ...
              <div class="mt-6 flex items-center gap-3">
                ...
                >
                  ...
                  <span v-else>
                    {{ isEdit ? t('catalog.providers.updateProvider') : t('catalog.providers.createProvider') }}
                  </span>
                </button>
                <RouterLink
                  :to="isEdit && providerId ? { name: 'catalog-providers-detail', params: { id: providerId } } : { name: 'catalog-providers-list' }"
