...
import { useDependencyExport } from '@/apps/monitoring/dependency/composables/useDependencyExport';
import { useDependencyFilters } from '@/apps/monitoring/dependency/composables/useDependencyFilters';
import { useDependencyGrouping } from '@/apps/monitoring/dependency/composables/useDependencyGrouping';
import { useDependencyStats } from '@/apps/monitoring/dependency/composables/useDependencyStats';
...
const allDeps = computed<Dependency[]>(() => dependencyStore.dependencies ?? []);
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-3 text-sm">
                ...
                >
                <span v-if="row.dep.registryStatus === 'pending'" class="text-text-muted italic">{{
