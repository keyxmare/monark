...
import type { PaginatedData } from '@/hub/shared/types/crud';
import type { CreateFrameworkInput, Framework } from '@/apps/monitoring/catalog/types/framework';
import { createCrudService } from '@/hub/shared/services/createCrudService';
import { api } from '@/hub/shared/utils/api';

const BASE_URL = '/monitoring/catalog/frameworks';
