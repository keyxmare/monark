...
#[Route('/api/assessment/questions', name: 'assessment_questions_create', methods: ['POST'])]
final readonly class CreateQuestionController
{
    ...
    public function __invoke(#[MapRequestPayload] CreateQuestionInput $input): JsonResponse
    {
        $envelope = $this->commandBus->dispatch(new CreateQuestionCommand($input));
