...
#[Route('/api/assessment/questions/{id}', name: 'assessment_questions_update', methods: ['PUT'])]
final readonly class UpdateQuestionController
{
    ...
    public function __invoke(string $id, #[MapRequestPayload] UpdateQuestionInput $input): JsonResponse
    {
        $envelope = $this->commandBus->dispatch(new UpdateQuestionCommand($id, $input));
