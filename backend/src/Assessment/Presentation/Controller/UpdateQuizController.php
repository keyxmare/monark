...
#[Route('/api/assessment/quizzes/{id}', name: 'assessment_quizzes_update', methods: ['PUT'])]
final readonly class UpdateQuizController
{
    ...
    public function __invoke(string $id, #[MapRequestPayload] UpdateQuizInput $input): JsonResponse
    {
        $envelope = $this->commandBus->dispatch(new UpdateQuizCommand($id, $input));
