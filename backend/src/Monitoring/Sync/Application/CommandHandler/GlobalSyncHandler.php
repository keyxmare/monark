...
namespace App\Monitoring\Sync\Application\CommandHandler;
...
use App\Monitoring\Sync\Application\Command\GlobalSyncCommand;
...
final readonly class GlobalSyncHandler
{
    ...
    private function publishProgress(string $syncId, \App\Monitoring\Sync\Domain\Model\GlobalSyncJob $job): void
    {
        try {
