...
namespace App\Monitoring\Coverage\Application\CommandHandler;
...
use App\Monitoring\Coverage\Domain\Model\CoverageSource;
            ...
            if ($coverageProvider !== null) {
                ...
                if ($result !== null) {
                    $jobsData = $result->jobs !== []
                        ? \array_map(
                            static fn (\App\Monitoring\Coverage\Domain\ValueObject\JobCoverage $j): array => [
                                'name' => $j->name,
                                'percent' => $j->percent,
                            ],
                            $result->jobs,
