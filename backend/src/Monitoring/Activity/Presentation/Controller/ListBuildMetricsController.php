...
#[Route('/activity/projects/{projectId}/build-metrics', name: 'activity_build_metrics_list', methods: ['GET'])]
#[OA\Get(
...
final readonly class ListBuildMetricsController
{
    ...
    public function __invoke(string $projectId, Request $request): JsonResponse
    {
        ...
        /** @var \App\Monitoring\Activity\Application\DTO\BuildMetricListOutput $result */
