...
use App\Hub\Identity\Application\Command\RegisterUserCommand;
...
use App\Hub\Identity\Presentation\Controller\GetCurrentUserController;
use App\Hub\Identity\Presentation\Controller\GetUserController;
use App\Hub\Identity\Presentation\Controller\ListUsersController;
use App\Hub\Identity\Presentation\Controller\LoginController;
use App\Hub\Identity\Presentation\Controller\LogoutController;
use App\Hub\Identity\Presentation\Controller\RegisterController;
use App\Hub\Identity\Presentation\Controller\UpdateUserController;
...
it('lists users with pagination', function () {
    ...
    $response = $controller(Request::create('/api/v1/hub/identity/users', 'GET', ['page' => 1]));
