...
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\DockerDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\GoDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\JavaScriptDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\PhpDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\PythonDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\RubyDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\Detector\RustDetector;
use App\Monitoring\Catalog\Infrastructure\Scanner\ProjectScanner;
...
describe('ProjectScanner', function () {
    ...
    it('returns empty result when API throws instead of crashing', function () {
        $gitClient = new class () implements GitProviderInterface {
            ...
            public function getProject(Provider $provider, string $externalId): \App\Monitoring\Catalog\Domain\Model\RemoteProject
            {
                throw new \RuntimeException('Not implemented');
            }
            public function getFileContent(Provider $provider, string $externalProjectId, string $filePath, string $ref = 'main'): ?string
