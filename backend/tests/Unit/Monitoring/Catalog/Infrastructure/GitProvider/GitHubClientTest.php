...
use App\Monitoring\Catalog\Infrastructure\GitProvider\GitHubClient;
use Symfony\Component\HttpClient\MockHttpClient;
use Symfony\Component\HttpClient\Response\MockResponse;
use Tests\Factory\Monitoring\Catalog\ProviderFactory;

function githubProvider(): \App\Monitoring\Catalog\Domain\Model\Provider
{
...
function githubProviderPublicOnly(): \App\Monitoring\Catalog\Domain\Model\Provider
{
    return ProviderFactory::create(
        name: 'GitHub Public',
        type: ProviderType::GitHub,
...
function githubProviderEmptyToken(): \App\Monitoring\Catalog\Domain\Model\Provider
{
    return ProviderFactory::create(
...
function githubProviderGithubDotCom(): \App\Monitoring\Catalog\Domain\Model\Provider
{
    return ProviderFactory::create(
        name: 'GitHub.com',
        type: ProviderType::GitHub,
...
function githubProviderGithubDotComTrailingSlash(): \App\Monitoring\Catalog\Domain\Model\Provider
{
    return ProviderFactory::create(
...
function githubProviderCustomUrl(): \App\Monitoring\Catalog\Domain\Model\Provider
{
    return ProviderFactory::create(
