...
use App\Monitoring\Catalog\Application\CommandHandler\ImportProjectsHandler;
use App\Monitoring\Catalog\Application\DTO\ImportProjectItem;
    ...
    return new class ($existingExternalIds, $existingSlugs) implements ProjectRepositoryInterface {
        ...
        public function findBySlug(string $slug): ?Project
        {
            return \in_array($slug, $this->existingSlugs, true) ? Project::create(
                ...
                defaultBranch: 'main',
                visibility: \App\Monitoring\Catalog\Domain\Model\ProjectVisibility::Private,
                ownerId: Uuid::v7(),
            ) : null;
        }
