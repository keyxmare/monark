...
use App\Hub\Shared\Domain\DTO\DetectedDependency;
...
use App\Hub\Shared\Domain\Port\DependencyWriterPort;
...
use App\Monitoring\Catalog\Domain\Port\ProjectScannerInterface;
...
use Tests\Factory\Monitoring\Catalog\ProviderFactory;

function stubScanGitProviderFactory(): \App\Monitoring\Catalog\Domain\Port\GitProviderFactoryInterface
{
    return new class () implements \App\Monitoring\Catalog\Domain\Port\GitProviderFactoryInterface {
        public function create(\App\Monitoring\Catalog\Domain\Model\Provider $provider): \App\Monitoring\Catalog\Domain\Port\GitProviderInterface
        {
            return new class () implements \App\Monitoring\Catalog\Domain\Port\GitProviderInterface {
                public function listProjects(\App\Monitoring\Catalog\Domain\Model\Provider $provider, int $page = 1, int $perPage = 20, ?string $search = null, ?string $visibility = null, string $sort = 'name', string $sortDir = 'asc'): array
                {
                    return [];
                }
                public function countProjects(\App\Monitoring\Catalog\Domain\Model\Provider $provider, ?string $search = null, ?string $visibility = null): int
                {
                    return 0;
                }
                public function testConnection(\App\Monitoring\Catalog\Domain\Model\Provider $provider): bool
                {
                    return true;
                }
                public function getProject(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalId): \App\Monitoring\Catalog\Domain\Model\RemoteProject
                {
                    throw new \RuntimeException('not implemented');
                }
                public function getFileContent(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalProjectId, string $filePath, string $ref = 'main'): ?string
                {
                    return null;
                }
                public function listDirectory(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalProjectId, string $path = '', string $ref = 'main'): array
                {
                    return [];
                }
                public function listBranches(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalProjectId): array
                {
                    return ['main'];
                }
                public function getRepositoryLanguages(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalProjectId): array
                {
                    return [];
                }
                public function getRecentCommits(\App\Monitoring\Catalog\Domain\Model\Provider $provider, string $externalProjectId, \DateTimeImmutable $since): array
                {
                    return [];
                }
            };
