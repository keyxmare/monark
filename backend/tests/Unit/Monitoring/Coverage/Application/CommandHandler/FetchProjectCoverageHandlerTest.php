...
use App\Monitoring\Coverage\Application\CommandHandler\FetchProjectCoverageHandler;
use App\Monitoring\Coverage\Domain\Model\CoverageSnapshot;
use App\Monitoring\Coverage\Domain\Port\CoverageProviderInterface;
...
use App\Monitoring\Coverage\Infrastructure\Provider\CoverageProviderRegistry;
...
describe('FetchProjectCoverageHandler', function () {
    ...
    it('persists jobs from CoverageResult into snapshot', function () {
        $coverageResult = new CoverageResult(
            ...
            pipelineId: '999',
            jobs: [
                new \App\Monitoring\Coverage\Domain\ValueObject\JobCoverage('backend', 92.0),
                new \App\Monitoring\Coverage\Domain\ValueObject\JobCoverage('frontend', 78.5),
            ],
        );
