...
use App\Monitoring\Dependency\Application\QueryHandler\ListVulnerabilitiesHandler;
use App\Monitoring\Dependency\Domain\Model\Dependency;
use App\Monitoring\Dependency\Domain\Model\Vulnerability;
...
function stubListVulnRepo(array $vulnerabilities = [], int $count = 0): VulnerabilityRepositoryInterface
{
    return new class ($vulnerabilities, $count) implements VulnerabilityRepositoryInterface {
        ...
        public function findByDependencyId(Uuid $dependencyId): array
        {
            return [];
        }
    };
