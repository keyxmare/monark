...
use App\Monitoring\Dependency\Presentation\Controller\SyncDependencyVersionsController;
...
describe('SyncDependencyVersionsController', function () {
    it('dispatches sync command and returns 202', function () {
        ...
        $depRepo = new class () implements DependencyRepositoryInterface {
            public function findById(Uuid $id): ?\App\Monitoring\Dependency\Domain\Model\Dependency
            {
                return null;
            }
            ...
            public function save(\App\Monitoring\Dependency\Domain\Model\Dependency $dependency): void
            {
            }
            public function delete(\App\Monitoring\Dependency\Domain\Model\Dependency $dependency): void
            {
            }
            ...
            public function findByNameManagerAndProjectId(string $name, string $packageManager, Uuid $projectId): ?\App\Monitoring\Dependency\Domain\Model\Dependency
            {
                return null;
            }
