...
use App\Monitoring\Dependency\Application\DTO\DependencyStatsOutput;
use App\Monitoring\Dependency\Application\Query\GetDependencyStatsQuery;
use App\Monitoring\Dependency\Presentation\Controller\GetDependencyStatsController;
...
describe('GetDependencyStatsController', function () {
    it('returns stats with filters', function () {
        ...
        $request = Request::create('/api/v1/monitoring/dependency/stats', 'GET', [
            'project_id' => 'p-1',
