...
use App\Monitoring\Dependency\Application\Command\CreateVulnerabilityCommand;
use App\Monitoring\Dependency\Application\Command\DeleteDependencyCommand;
use App\Monitoring\Dependency\Application\Command\UpdateDependencyCommand;
use App\Monitoring\Dependency\Application\Command\UpdateVulnerabilityCommand;
use App\Monitoring\Dependency\Application\DTO\CreateDependencyInput;
use App\Monitoring\Dependency\Application\DTO\CreateVulnerabilityInput;
use App\Monitoring\Dependency\Application\DTO\DependencyListOutput;
...
use App\Monitoring\Dependency\Application\DTO\UpdateVulnerabilityInput;
use App\Monitoring\Dependency\Application\DTO\VulnerabilityListOutput;
use App\Monitoring\Dependency\Application\DTO\VulnerabilityOutput;
use App\Monitoring\Dependency\Application\Query\GetDependencyQuery;
use App\Monitoring\Dependency\Application\Query\GetVulnerabilityQuery;
use App\Monitoring\Dependency\Application\Query\ListDependenciesQuery;
use App\Monitoring\Dependency\Application\Query\ListVulnerabilitiesQuery;
use App\Monitoring\Dependency\Presentation\Controller\CreateDependencyController;
use App\Monitoring\Dependency\Presentation\Controller\CreateVulnerabilityController;
use App\Monitoring\Dependency\Presentation\Controller\DeleteDependencyController;
use App\Monitoring\Dependency\Presentation\Controller\GetDependencyController;
use App\Monitoring\Dependency\Presentation\Controller\GetVulnerabilityController;
use App\Monitoring\Dependency\Presentation\Controller\ListDependenciesController;
use App\Monitoring\Dependency\Presentation\Controller\ListVulnerabilitiesController;
use App\Monitoring\Dependency\Presentation\Controller\UpdateDependencyController;
use App\Monitoring\Dependency\Presentation\Controller\UpdateVulnerabilityController;
...
it('lists dependencies with project filter', function () {
    ...
    $response = (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['project_id' => 'p-1']));
...
it('lists dependencies with custom page and perPage', function () {
    ...
    $response = (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['page' => '3', 'per_page' => '50']));
...
it('lists dependencies with all query parameters', function () {
    ...
    $response = (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', [
        'page' => '2',
        'per_page' => '10',
        'project_id' => 'proj-123',
        'search' => 'vue',
...
it('parses is_outdated=true as true', function () {
    $bus = \stubDependencyBus(new DependencyListOutput(new PaginatedOutput(items: [], total: 0, page: 1, perPage: 20)));
    (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['is_outdated' => 'true']));
...
it('parses is_outdated=1 as true', function () {
    $bus = \stubDependencyBus(new DependencyListOutput(new PaginatedOutput(items: [], total: 0, page: 1, perPage: 20)));
    (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['is_outdated' => '1']));
...
it('parses is_outdated=0 as false', function () {
    $bus = \stubDependencyBus(new DependencyListOutput(new PaginatedOutput(items: [], total: 0, page: 1, perPage: 20)));
    (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['is_outdated' => '0']));
...
it('parses is_outdated=false as false', function () {
    $bus = \stubDependencyBus(new DependencyListOutput(new PaginatedOutput(items: [], total: 0, page: 1, perPage: 20)));
    (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET', ['is_outdated' => 'false']));
...
it('leaves is_outdated null when not provided', function () {
    $bus = \stubDependencyBus(new DependencyListOutput(new PaginatedOutput(items: [], total: 0, page: 1, perPage: 20)));
    (new ListDependenciesController($bus))(Request::create('/api/v1/monitoring/dependency/dependencies', 'GET'));
...
it('lists vulnerabilities', function () {
    ...
    $response = (new ListVulnerabilitiesController($bus))(Request::create('/api/v1/monitoring/dependency/vulnerabilities'));
