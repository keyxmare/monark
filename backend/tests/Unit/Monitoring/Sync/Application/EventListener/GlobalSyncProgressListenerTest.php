...
use App\Monitoring\Sync\Application\EventListener\GlobalSyncProgressListener;
...
describe('GlobalSyncProgressListener', function (): void {
    ...
    it('skips to SyncDependencies when last project scanned but no eligible projects', function (): void {
        $job = GlobalSyncJob::create();
