...
use App\Monitoring\VersionRegistry\Application\CommandHandler\SyncSingleProductHandler;
...
use App\Monitoring\VersionRegistry\Domain\Port\VersionResolverInterface;
...
use App\Monitoring\VersionRegistry\Domain\Service\VersionResolverSelector;
...
describe('SyncSingleProductHandler', function () {
    ...
    it('updates existing version instead of creating new one', function () {
        $product = Product::create('php', ProductType::Language, ResolverSource::EndOfLife);
        $existingVersion = App\Monitoring\VersionRegistry\Domain\Model\ProductVersion::create('php', '8.4.2');
