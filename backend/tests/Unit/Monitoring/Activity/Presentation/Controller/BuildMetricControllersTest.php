...
use App\Monitoring\Activity\Application\Command\CreateBuildMetricCommand;
...
use App\Monitoring\Activity\Application\Query\GetLatestBuildMetricQuery;
use App\Monitoring\Activity\Application\Query\ListBuildMetricsQuery;
use App\Monitoring\Activity\Presentation\Controller\CreateBuildMetricController;
use App\Monitoring\Activity\Presentation\Controller\GetLatestBuildMetricController;
use App\Monitoring\Activity\Presentation\Controller\ListBuildMetricsController;
...
it('lists build metrics with pagination', function () {
    ...
    $request = Request::create('/api/v1/monitoring/activity/projects/proj-1/build-metrics', 'GET', ['page' => 2, 'per_page' => 10]);
...
it('lists build metrics with default pagination', function () {
    ...
    $request = Request::create('/api/v1/monitoring/activity/projects/proj-1/build-metrics', 'GET');
    $response = $controller('proj-1', $request);
