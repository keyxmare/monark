...
function stubListTechStacksRepo(array $techStacks = [], int $count = 0): TechStackRepositoryInterface
{
    return new class ($techStacks, $count) implements TechStackRepositoryInterface {
        ...
        public function findAll(int $page = 1, int $perPage = 20): array { return $this->techStacks; }
        public function findByProjectId(Uuid $projectId, int $page = 1, int $perPage = 20): array { return $this->techStacks; }
        public function countByProjectId(Uuid $projectId): int { return $this->count; }
