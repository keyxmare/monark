...
it('creates a project and returns 201', function () {
    $output = new ProjectOutput('uuid-1', 'Monark', 'monark', null, 'https://github.com/x/y', 'main', 'private', 'owner-1', null, null, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00');
...
it('updates a project and returns 200', function () {
    $output = new ProjectOutput('uuid-1', 'Updated', 'updated', null, 'https://github.com/x/y', 'main', 'private', 'owner-1', null, null, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00');
    $bus = \stubProjectBus($output);
