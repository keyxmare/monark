...
function createBuildMetricViaApi(object $context, array $overrides = []): array
{
    ...
    $context->client->request('POST', "/api/v1/monitoring/activity/projects/{$context->projectId}/build-metrics", [], [], [
...
describe('POST /api/v1/activity/projects/{projectId}/build-metrics', function () {
    it('creates a build metric and returns 201', function () {
        ...
        $this->client->request('POST', "/api/v1/monitoring/activity/projects/{$this->projectId}/build-metrics", [], [], \array_merge(
...
describe('GET /api/v1/activity/projects/{projectId}/build-metrics', function () {
    it('lists build metrics with pagination', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/activity/projects/{$this->projectId}/build-metrics?page=1&per_page=10", [], [], $this->authHeader($this->token));
...
describe('GET /api/v1/activity/projects/{projectId}/build-metrics/latest', function () {
    it('gets the latest build metric', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/activity/projects/{$this->projectId}/build-metrics/latest", [], [], $this->authHeader($this->token));
