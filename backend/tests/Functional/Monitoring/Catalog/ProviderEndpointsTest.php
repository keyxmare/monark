...
describe('POST /api/v1/catalog/providers', function () {
    it('creates a provider and returns 201', function () {
        ...
        $this->client->request('POST', '/api/v1/monitoring/catalog/providers', [], [], \array_merge(
...
describe('GET /api/v1/catalog/providers', function () {
    it('lists providers with pagination', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/catalog/providers?page=1&per_page=10', [], [], $this->authHeader($this->token));
...
describe('GET /api/v1/catalog/providers/{id}', function () {
    it('gets a provider by id', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/catalog/providers/{$providerId}", [], [], $this->authHeader($this->token));
    ...
    it('returns 404 for unknown provider', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/catalog/providers/{$fakeId}", [], [], $this->authHeader($this->token));
...
describe('PUT /api/v1/catalog/providers/{id}', function () {
    it('updates a provider', function () {
        ...
        $this->client->request('PUT', "/api/v1/monitoring/catalog/providers/{$providerId}", [], [], \array_merge(
            $this->authHeader($this->token),
            ['CONTENT_TYPE' => 'application/json'],
        ), \json_encode([
...
describe('DELETE /api/v1/catalog/providers/{id}', function () {
    it('deletes a provider', function () {
        ...
        $this->client->request('DELETE', "/api/v1/monitoring/catalog/providers/{$providerId}", [], [], $this->authHeader($this->token));
