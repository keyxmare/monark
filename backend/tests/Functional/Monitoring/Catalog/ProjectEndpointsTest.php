...
describe('POST /api/v1/catalog/projects', function () {
    it('creates a project and returns 201', function () {
        ...
        $this->client->request('POST', '/api/v1/monitoring/catalog/projects', [], [], \array_merge(
...
describe('GET /api/v1/catalog/projects', function () {
    it('lists projects with pagination', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/catalog/projects?page=1&per_page=10', [], [], $this->authHeader($this->token));
...
describe('GET /api/v1/catalog/projects/{id}', function () {
    it('gets a project by id', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/catalog/projects/{$projectId}", [], [], $this->authHeader($this->token));
    ...
    it('returns 404 for unknown project', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/catalog/projects/{$fakeId}", [], [], $this->authHeader($this->token));
...
describe('PUT /api/v1/catalog/projects/{id}', function () {
    it('updates a project', function () {
        ...
        $this->client->request('PUT', "/api/v1/monitoring/catalog/projects/{$projectId}", [], [], \array_merge(
            $this->authHeader($this->token),
            ['CONTENT_TYPE' => 'application/json'],
        ), \json_encode([
            'name' => 'Updated Name',
...
describe('DELETE /api/v1/catalog/projects/{id}', function () {
    it('deletes a project', function () {
        ...
        $this->client->request('DELETE', "/api/v1/monitoring/catalog/projects/{$projectId}", [], [], $this->authHeader($this->token));
