...
function createDependencyViaApi(object $context, array $overrides = []): array
{
    ...
    $context->client->request('POST', '/api/v1/monitoring/dependency/dependencies', [], [], [
...
describe('POST /api/v1/dependency/dependencies', function () {
    it('creates a dependency and returns 201', function () {
        ...
        $this->client->request('POST', '/api/v1/monitoring/dependency/dependencies', [], [], \array_merge(
...
describe('GET /api/v1/dependency/dependencies', function () {
    it('lists dependencies with pagination', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/dependency/dependencies?page=1&per_page=10', [], [], $this->authHeader($this->token));
    ...
    it('filters by package_manager', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/dependency/dependencies?package_manager=npm', [], [], $this->authHeader($this->token));
    ...
    it('filters by is_outdated', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/dependency/dependencies?is_outdated=1', [], [], $this->authHeader($this->token));
    ...
    it('searches by name', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/dependency/dependencies?search=symfony', [], [], $this->authHeader($this->token));
...
describe('GET /api/v1/dependency/dependencies/{id}', function () {
    it('gets a dependency by id', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/dependency/dependencies/{$dependencyId}", [], [], $this->authHeader($this->token));
    ...
    it('returns 404 for unknown dependency', function () {
        ...
        $this->client->request('GET', "/api/v1/monitoring/dependency/dependencies/{$fakeId}", [], [], $this->authHeader($this->token));
...
describe('PUT /api/v1/dependency/dependencies/{id}', function () {
    it('updates a dependency', function () {
        ...
        $this->client->request('PUT', "/api/v1/monitoring/dependency/dependencies/{$dependencyId}", [], [], \array_merge(
            $this->authHeader($this->token),
            ['CONTENT_TYPE' => 'application/json'],
        ), \json_encode([
...
describe('DELETE /api/v1/dependency/dependencies/{id}', function () {
    it('deletes a dependency', function () {
        ...
        $this->client->request('DELETE', "/api/v1/monitoring/dependency/dependencies/{$dependencyId}", [], [], $this->authHeader($this->token));
...
describe('GET /api/v1/dependency/stats', function () {
    it('returns dependency stats', function () {
        ...
        $this->client->request('GET', '/api/v1/monitoring/dependency/stats', [], [], $this->authHeader($this->token));
...
describe('POST /api/v1/dependency/sync', function () {
    it('triggers sync and returns 202 with syncId', function () {
        $this->client->request('POST', '/api/v1/monitoring/dependency/sync', [], [], \array_merge(
            $this->authHeader($this->token),
            ['CONTENT_TYPE' => 'application/json'],
        ));
