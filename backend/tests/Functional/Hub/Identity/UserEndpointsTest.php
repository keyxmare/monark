...
describe('GET /api/v1/identity/users', function () {
    it('lists users with pagination', function () {
        $this->client->request('GET', '/api/v1/hub/identity/users', [], [], $this->authHeader($this->token));
    ...
    it('returns 401 without auth', function () {
        $this->client->request('GET', '/api/v1/hub/identity/users');
...
describe('GET /api/v1/identity/users/{id}', function () {
    it('gets a user by id', function () {
        ...
        $this->client->request('GET', "/api/v1/hub/identity/users/{$userId}", [], [], $this->authHeader($this->token));
    ...
    it('returns 404 for unknown user', function () {
        ...
        $this->client->request('GET', "/api/v1/hub/identity/users/{$fakeId}", [], [], $this->authHeader($this->token));
...
describe('PUT /api/v1/identity/users/{id}', function () {
    it('updates user fields', function () {
        ...
        $this->client->request('PUT', "/api/v1/hub/identity/users/{$userId}", [], [], \array_merge(
